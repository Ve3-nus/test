    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            180-170 Koinage Street, Nairobi.
          </address>
            <div class="phone">
              Telephone:
            ...
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">wonderv@strathmore.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="developer">
            Developed by Vin Wonder
          </div>

          <div class="designby">
            Design by Vin Wonder
          </div>
